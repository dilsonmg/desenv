...
<table width="99%" border="0">
	...
	echo($_SESSION['id_entmatp']);
      ...
      <tr>
        ...
        <th colspan="2" align="left"><select name="cod_prod"  class="search-input7" <?php if($habilita ==1) echo(" disabled ");?> onChange="atualiza();">
...
//		
      ...
      <tr>
        ...
        <th align="right"><?php echo($venc);?></th>
        <th align="left"></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        value="<?php echo ($data_saida); ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_saida);" onChange="verifica_data(this.value,data_saida);" class="search-input6"/></th>
      ...
      <tr>
        ...
        <th colspan="2" align="left"><input type="text" id = "unidade"  name="unidade"  maxlength="10" size="10" placeholder="informe a unidade"  value="<?php echo($unidade); ?>" class="search-input6" ></th>
        <th align="right">Lote Produzido</th>
        <th align="left"><input type="text" id = "lote_fabricado"  name="lote_fabricado"  maxlength="15" size="12" placeholder="informe o Numero do lote !"  value="<?php echo($lote_fabricado); ?>" class="search-input6"></th>
      </tr>
      <tr>
