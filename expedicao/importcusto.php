...
//echo(" <img src='../imagens/aguarde.gif'  />");
...
/*================================ importar dados de produtos ==============================*/
		...
		*/
		...
		$rscc = mysql_query("select a.* from tb_produto a where a.cod_prod = '". $data[2] . "'");

        $row_custo = mysql_fetch_assoc($rscc);
	    $flag_custo =  $row_nmpr['flag_calccusto'];
