...
$rs2 = mysql_query("SELECT a.cod_prod,b.descr_prod, year(a.data_nf) ano, month(a.data_nf) mes ,
					...
					inner join tb_produto b on a.cod_prod = b.cod_prod " . $p1n . "
...
<table width="100%" border="1" cellspacing="0"   align="center"   >
  ...
  <tr>
    <th  align="center" valign="top" >Produto
      <input type="text" name="prodpesq" id="prodpesq" maxlenght="50" size="40" /></th>
