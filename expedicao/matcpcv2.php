...
if (isset($data_1)){
	if ($data_1 <> "" ){
		 $p1a = " and a.data_fabr >= '" . formata_data2($data_1) ."'" ; 
	}
}
...
if (isset($data_2)){
	if ($data_2 <> "" ){
		 $p1b = " and a.data_fabr <= '" . formata_data2($data_2) ."'" ; 	
		 }
}
...
if($cod_prod == ""){$p1 = "";}
 ...
 $rs2 = mysql_query("select a.*,b.descr_prod
					...
					"where a.id_contraprov > 0 " . $p1 . $p01 . $p1a . $p1b ."  and a.situacao = 'A' order by a.data_fabr,a.num_lote asc");				  
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="center" ><h1>Consulta por Dt. Fabrica&ccedil;&atilde;o Contraprova - Produtos Acabados- 
        <?php
	echo($_SESSION['id_entmatp']);
      ...
      <tr>
        <th colspan="4" align="center"><input type="button" onClick="sair();" value="Sair">
        </th>
        </tr>
            <tr >
