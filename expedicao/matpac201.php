...
<table width="95%" border="0">
      <tr>
        <th ><img src="../imagens/logoqrred.jpg"></th>
        <th colspan="3" align="center"><img src="../imagens/tecladoclaro.png" ></th>
      </tr>
      <tr>
      <th height="45" colspan="4" align="center"><h1>Consulta Produtos Acabados Liberados- 
        <?php
        ...
        <th align="left"><select name="id_entprodac" style="font-size:10" <?php if($habilita ==1) echo(" disabled ");?>  onChange="atualiza();">
            ...
            <option value="<?php print($row33['id_entprodac'])?>"
				  <? if($row33['id_entprodac'] == $id_entprodac) {
						 ...
						 $resultado1       = $row33['resultado1'];
                         $resultado2       = $row33['resultado2'];
         				 $resultado3       = $row33['resultado3'];
         				 $resultado4       = $row33['resultado4'];
         	             $resultado5       = $row33['resultado5'];
         	             $resultado6       = $row33['resultado6'];
         	             $resultado7       = $row33['resultado7'];
         	             $resultado8       = $row33['resultado8'];
         	             $resultado9       = $row33['resultado9'];
         	             $resultado10      = $row33['resultado10'];
         	             $resultado11      = $row33['resultado11'];
	...
	?>
      ...
      <tr>
        <th colspan="5" align="center">
          <input type="button" name="gravar"  onClick="validamatpacb2('a1');" value="Gravar" style="font:color="#006600"-size:8" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="resetForm();" >
          <input type="button" name="Submit4"  onclick="excluirmatpacb(<?php echo($id); ?>);" value="Excluir" style="font:color="#006600"-size:8" />
          <input type="button" onClick="sair();" value="Sair">
        </th>
        </tr>
            <tr >
              <th colspan="5" align="center">    Produto
            ...
            <tr >
              <th colspan="5" align="center"><h1>Produtos para Libera&ccedil;&atilde;o</h1></th>
            </tr>
            <tr align="center">
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
           ...
           <?php  if ($row['data_liblote'] != "") { ?>  
                   <a href="matpac201.php?id=<?php echo ($row['id_entprodac']);?>"><?php echo ($row['descr_prod']); ?></a>
