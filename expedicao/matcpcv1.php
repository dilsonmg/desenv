...
if($cod_prod == ""){$p1 = "";}
 ...
 $rs2 = mysql_query("select a.*,b.descr_prod
					...
					"where a.id_contraprov > 0 " . $p1 . $p01 . $p1a . $p1b ."  and a.situacao = 'A' order by a.venci_retencao asc");				  
...
<![endif]-->
	<title>MATCPCV1 - CONSULTA VENCIMENTO - CONTRAPROVA PRODUTO ACABADO</title>
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="center" ><h1>Consulta por Vencimento Contraprova - Produtos Acabados- 
        <?php
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
         ...
         <?php echo ($row['cod_prod'] . " - " . $row['descr_prod']);?></td>
           ...
           <td align="center" ><?php echo ($row['venci_retencao1']);
