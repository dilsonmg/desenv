...
if ($a != "E") {
		...
		$data_fechamento,$doc_fecha,$obs_projeto,$a,$remvdcfech,$lote,$situacao);
	 ...
	 $cp2 = str_replace("'", "", $cp2);
	  ...
	  if ($cp10 <> "E") {   
	      ...
	      if ($a == 0){
              ...
              echo( "insert into tb_projeto(id_projeto,descr_projeto,solicitante,data_abertura,doc_abertura,data_prevtermino,
					            data_fechamento,doc_fecha,obs_projeto,lote,situacao)
  			                    values('$cp1','$cp2','$cp3','$cp4','$cp5','$cp6','$cp7','$cp8','$cp9','$cp12','$cp13')");
