	  ...
	  while($row=mysql_fetch_array($rs2)){ 
         if ($row['cod_prod'] != $cd_prodini ){  ?>
                <tr bgcolor="#E1E1FF">
                  ...
                  <td align="center" >&nbsp;</td>
                  <td align="center" >&nbsp;</td>
                  <td align="center" ><b><?php echo ($tot_lote);?></b></td>
                  <td align="center" >&nbsp;</td>
                  <td align="center" >&nbsp;</td>
                  <td align="center" >&nbsp;</td>
                  <td align="center" >&nbsp;</td>
...
echo ($row['linha']);?></td>
    ...
    $b = mysql_num_rows($rscv);
           ...
           <td align="center" ><input type="text" name="quantid" value="" size="8" maxlength="10" align="right"  ></td>
           <td align="center" ><input type="text" name="num_pedido" value="" size="10" maxlength="10" align="right"  ></td>
           <td align="center" ><input type="text" name="codigo_cli" value="" size="8" maxlength="10" align="right"  ></td>
           <td align="center" >        
