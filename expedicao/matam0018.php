...
//DATEDIFF(t.data_conserto,CURDATE())
 ...
 $rs2 =mysql_query("SELECT a.id_entitproc,a.cod_prod,a.num_lote,a.quant_it,b.descr_prod, b.linha, DATE_FORMAT(a.data_ent, '%d/%m/%Y') data_ent1,
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="center"><h1>Amostra - Consulta Saldo de  Processados- </h1>  </th> 
        <th align="right"><img src="../imagens/tecladoclaro.png" >
        <br>          <?php echo($hoje); ?> <a  href=javascript:window.print()><img border="0" src="../imagens/print.png"    title="Imprimir"></a>
        </th>
      </tr>
 </table>
<table width="95%" border="0">
      ...
      <tr>
        <th colspan="3" align="center"><input type="button" onClick="sair();" value="Sair" class="search-submit2">
            ...
            <tr >
              <th colspan="3" align="center" bgcolor="#A6A6FF">Processados</th>
            </tr>
            <tr >
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
           ...
           <!--th align="center" ><?php // echo($row['data_fabr']);?></th-->
           <!--th  align="center" ><?php  /*	echo($row['data_venc']);
