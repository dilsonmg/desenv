...
<div class="menu-container" align="center">
  <ul class="menu clearfix">
        ...
        <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300') { ?>
          ...
          <?php } ?>
        <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300'|| $_SESSION['permi'] == '305') { ?>
         ...
         <li><a href="#">Mat&eacute;rias-Primas</a>
           ...
           <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300') { ?>
                      ...
                      <li><a href="matpcv003.php">Consulta Saidas</a></li>
          <?php } ?>
        <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300'|| $_SESSION['permi'] == '305' || $_SESSION['permi'] == '111') { ?>
        ...
        <li><a href="#">Rastreablidade</a>
              <ul class="sub-menu clearfix"> 
             <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300'|| $_SESSION['permi'] == '111' || $_SESSION['permi'] == '305') { ?>
        ...
        <!---------------------------------------------------->
          ...
          <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300') { ?>             
                         ...
                         <?php } ?>     
                        <?php if ($_SESSION['permi'] == '999' || $_SESSION['permi'] == '222'  || $_SESSION['permi'] == '300' || $_SESSION['permi'] == '111') { ?>             
