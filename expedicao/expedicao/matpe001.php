...
<table width="98%" border="0">
	...
	echo($_SESSION['id_entmatp']);
      ...
      <tr>
        ...
        <th colspan="2" align="left"><select name="cod_fornec" class="search-input5">
      ...
      <tr>
        ...
        <th colspan="2" align="left"><input type="text" id = "nm_fabric" class="search-input5" required name="nm_fabric"  maxlength="100" size="80" placeholder="informe o fabricante"   value="<?php echo($nm_fabric); ?>" ></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        onChange="javascript:rec_pag();" value="<?php echo($num_nf); ?>" class="search-input5" ></th>
        <th align="right">Data NF</th>
        <th colspan="2" align="left"><input type="text" name="data_nf" size="8" maxlength="10"  placeholder="Informe no formato 99/99/9999" value="<?php echo $data_nf ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_nf);" onChange="verifica_data(this.value,data_nf);" class="search-input3"/></th>
      </tr>
      <tr>
        <th  align="right">Quantidade</th>
        <th align="left"><input type="text" id = "quantid_ent" required name="quantid_ent"  maxlength="10" size="10" placeholder="informe a Quantidade"  value="<?php echo($quantid_ent); ?>" class="search-input5" ></th>
        <th align="right">Unidade</th>
        <th align="left"><input type="text" id = "unidade" required name="unidade"  maxlength="10" size="10" placeholder="informe a unidade"  value="<?php echo($unidade); ?>" class="search-input5" ></th>
      ...
      <tr>
        ...
        > 
          ...
          class="search-input3"/>
          Ativo Kamoran
          <input type="text" id = "atv_kamoran" required name="atv_kamoran"  maxlength="10" size="10" placeholder="informe o ativo"  value="<?php echo($atv_kamoran); ?>" class="search-input3" ></th>
      </tr>
      <tr>
        ...
        <textarea name="msg_lote" cols="105" rows="3"  onchange="textCounter(this.form.msg_lote,this.form.x,330);"  onKeyDown="textCounter(this.form.msg_lote,this.form.x,330);"  class="search-input5"  ><?php echo($msg_lote) ?></textarea></td></th>
      </tr>
      <tr>
