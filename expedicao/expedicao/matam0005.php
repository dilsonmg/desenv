...
order by d.num_nf desc,a.id_itsaidalt desc,d.data_nf desc, a.num_lote desc");
/*
*/				  		  
...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="2" align="center"><h1>Consulta Saidas dos Kits de Amostras- 
        <?php 
...
//echo($b);
       $bg = 0;
        ...
        <th colspan="3" align="center">Produto
          <input type="text" name="m_primapesq" id="m_primapesq" maxlenght="50" size=50 />          <input name="Pesquisar" type="submit" value="Pesquisar">          <input type="button" onClick="sair();" value="Sair">
        </th>
        </tr>
            <tr >
