...
$rs2 = mysql_query("select a.* ,
                    ...
                    from tb_documentos a where a.id_documento > 0 and year(a.data_autor) = 0 
				    and a.setor_doc = 1
                    and a.tipo_doc in(1,2,4,5,6,7,12,13,18)
				    " . $p4 . $p5 . " order by a.id_documento desc");				  
...
<![endif]-->
	<title>DOCTOAU01 - Liberacao de Documentos para Consulta</title>
...
<table width="100%" border="0">
      <tr>
        ...
        <th align="center"><h1>Libera&ccedil;&atilde;o de Documentos para Consulta- 
        <?php
	echo($_SESSION['id_entmatp']);
		  ?>       
      </h1>
      <br> Atencao ! Os arquivos tem que possuir no maximo 1.2 mb !</th>
        <th  align="right"><img src="../imagens/tecladoclaro.png" ><?php echo( $_SESSION['nome_usu']); ?></th>
      </tr>
      </table>
<table width="100%" border="0">
      ...
      <tr>
        ...
        <th align="left"><input type="text" id = "descr_docto" name="descr_docto" maxlength="100" size="100"  value="<?php echo($descr_docto); ?>" readonly ></th>
        <th align="right">Tipo de Documento</th>
        <th colspan="2" align="left">
        <select name="tipo_doc" style="font-size:10" disabled>
      ...
      <tr>
        ...
        <th align="left"><a href="javascript:ver_fotofab('<?php  echo($nome_doc);?>')"> Ver - <?php  echo($nome_doc);?> </a></th>
        <th align="right">Vers&atilde;o</th>
        <th colspan="2" align="left"><input type="text" id = "versao_doc" readonly name="versao_doc" maxlength="50" size="15"  value="<?php echo($versao_doc); ?>" ></th>
      </tr>
      <tr>
        <th align="right">Setor Documento</th>
        <th align="left"> 
        <select name="setor_doc" style="font-size:10" disabled>
        ...
        <th colspan="2" align="left"><input type="text" readonly name="num_paginas" size="8" placeholder="Informe num" maxlength="10" value="<?php echo $num_paginas ?>" title="Informe num. paginas" /></th>
      </tr>
      <tr>
        <th align="right">Data Emissao</th>
        <th align="left"><input type="text" name="data_emis" size="8" maxlength="10"  readonly placeholder="Informe no formato 99/99/9999" value="<?php echo $data_emis ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_emis);" onChange="verifica_data(this.value,data_emis);"/></th>
        <th align="right">Vencimento</th>
        <th colspan="2" align="left"><input type="text" name="data_venc" size="8" maxlength="10"  readonly placeholder="Informe no formato 99/99/9999" value="<?php echo $data_venc ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_venc);" onChange="verifica_data(this.value,data_venc);"/></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <th align="left"><input type="text" id = "verif_por" readonly  name="verif_por" placeholder="Informe o nome !" maxlength="80" size="80"  value="<?php echo($verif_por); ?>" ></th>
        <th align="right">Data</th>
        <th colspan="2" align="left"><input type="text" name="data_verif" size="8" readonly maxlength="10"  placeholder="Informe no formato 99/99/9999" value="<?php echo $data_verif ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_verif);" onChange="verifica_data(this.value,ddata_verif);"/></th>
      </tr>
      <tr>
        <th align="right">Autorizado  Por</th>
        <th align="left"><input type="text" id = "auto_por" readonly   name="auto_por" placeholder="Informe o nome !" maxlength="80" size="80" 
         value="<?php echo( $_SESSION['nome_usu']); ?>" ></th>
        <th align="right">Data</th>
      ...
      <tr>
        <th colspan="6" align="center">
		  ...
		  <?php }else { ?>
          <input type="button" name="gravar"  onClick="validaformlb();" value="Gravar" style="font:color="#006600"-size:8" />
        ...
        <th colspan="6" align="left">Selecione tipo de Documento 
          <select name="tipo_doc2" style="font-size:10" onChange="atualiza();">
            ...
            <option value="16" <?php if ($tipo_doc2 == 16){echo(" selected ");}?>>Reg. Marcas e Patentes</option>
             <option value="17" <?php if ($tipo_doc2 == 17){echo(" selected ");}?>>Termos</option>
             <option value="18" <?php if ($tipo_doc2 == 18){echo(" selected ");}?>>Documentos de Produ&ccedil;&atilde;o</option>
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
                  ...
                  <td >
           <a href="doctoau01.php?id=<?php echo ($row['id_documento']);?>"><?php echo ($row['id_documento']);?></a></td>
