...
$data_venc,$quantid_ent,$atv_kamoran,$a,$msg_lote,$nm_fabric,$motivo_ent,$localizacao);

header("Location: matpe001.php");


function gravarreg($cp1,$cp2,$cp3,$cp4,$cp5,$cp6,$cp7,$cp8,$cp9,$cp10,$cp11,$cp12,$cp13,$cp14,$cp15,$cp16,$cp17){
			...
			if ($a == 0){
				   ...
				   if ($cp1  == ""){
					   ...
					   echo("insert into tb_entmatp(id_entmatp,data_entrada,cod_fornec,cod_prod,unidade,num_nf,data_nf,num_lote,data_fab,
							data_venc,quantid_ent,atv_kamoran,msg_lote,nm_fabric,motivo_ent)
							values('$cp1','$cp2','$cp3','$cp4','$cp5','$cp6','$cp7','$cp8','$cp9','$cp10','$cp11','$cp12','$cp14','$cp15','$cp16')");
