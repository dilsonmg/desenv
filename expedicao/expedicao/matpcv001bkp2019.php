...
if (isset($data_3)){
	if ($data_3 <> "" ){
		 $p31 = " and a.data_venc >= '" . formata_data2($data_3) ."'" ; 
		 $d3 = $data_3;	
		 }}

if (isset($data_4)){
	if ($data_4 <> "" ){
		 $p32 = " and a.data_venc <= '" . formata_data2($data_4) ."'" ;
		 $d4 = $data_4; 		 
		 }}
...
<table width="100%" border="0">
      <tr>
        ...
        <br> <h2><?php if ($p31 != "" || $p32 != ""   ) { echo("Período de Vencimento Pesquisado de: " . $d3 . " a " . $d4); } ?></h2>
        </th>
      ...
      <tr>
        <th colspan="3" align="center">M. Prima
          <input type="text" id = "mprimaps" name="mprimaps"  maxlength="40" size="30" >
          Periodo
...
Linha
     ...
     Vencimento
          <input type="text" name="data_3" size="10" maxlength="10"  title="Informe no Formato 99/99/9999" onkeypress="mascara(this)" onblur="verifica_data(this.value,data_3);"/>
a
<input type="text" name="data_4" size="10" maxlength="10"  title="Informe no Formato 99/99/9999" onkeypress="mascara(this)" onblur="verifica_data(this.value,data_4);"/>
...
<input type="button" onClick="sair();" value="Sair"></th>
            ...
            <tr >
              <td colspan="4" align="center">
                ...
                <p>Período Pesquisado :<?php echo($dp1 . " a " . $dp2); ?></p>
			 <?php } else { 
				    	if(isset($dtp1)){?>
