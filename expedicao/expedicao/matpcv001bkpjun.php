      ...
      <tr>
        <th colspan="3" align="center">
          ...
          <input type="button" onClick="sair();" value="Sair">
            ...
            <tr >
              <td colspan="3" align="center"><h1>Vencimentos de Mat&eacute;rias Primas em : <?php echo($hoje); ?></h1>
              <p>Período Pesquisado :<?php echo($data_1 . " a " . $data_2); ?></p></td>
            </tr>
            <tr align="center">
...
//		      if ($row['msg_lote'] <> ""){ echo("<br> <font color=#999999> " . $row['msg_lote'] . "</font>");
	///		  }
		   ...
		   ?></td>
           <td align="right"><?php echo ($row['tt_lote'] -$row['quantid_ent'] + $row['quantid_said']); ?></td>
		  ...
		  ?>     
              <tr bgcolor="#E1E1FF">
               ...
               <tr>
                ...
                <td align="right"><b><?php echo ($totg_e);?></b></td>
                <td align="right"><b><?php echo ($totg_s);?></b></td>
