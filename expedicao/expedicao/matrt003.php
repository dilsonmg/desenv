...
if (isset($lote_fabr2)){
	if ($lote_fabr2 <> "" ){
        if(!is_numeric($lote_fabr2)){
		     $p1 = " and b.descr_prod like '%". $lote_fabr2 ."%'" ; }
		 else{
			 $p1 = " and b.cod_prod like '%" . $lote_fabr2 ."%'" ; }
		 }}
...
if (isset($data_1)){
	if ($data_1 <> "" ){
		 $p100a = " and a.data_nf >= '" . formata_data2($data_1) ."'" ; 
	 }
}

if (isset($data_2)){
	if ($data_2 <> "" ){
		 $p101b = " and a.data_nf <= '" . formata_data2($data_2) ."'" ; 
	 }
}
...
//    
	...
	$rs2 = mysql_query("SELECT a.*,b.descr_prod,c.nome_cli 
	  ...
	  where a.id_saidaprodac > 0   " . $p2 .$p100a .$p101b  . "	
	 order by a.data_fatura desc limit 550 ");			
...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="2" align="center"><h1>Rastreamento por Produto- 
        <?php
	echo($lote_fabr2);
		  ?>
      </h1></th></tr>
      <tr>
        <th colspan="2" align="center">Informe o Codigo ou Nome do Produto
...
?>
      ...
      <tr>
        <th colspan="2" align="center"  bgcolor="#8080FF">Dados da Saida</th>
            ...
            <tr >
              <th colspan="3" align="center"><h2> Produtos por Cliente -</h2></th>
            </tr>
</table>
<br>
