...
$rs2 = mysql_query("select a.* ,
                  ...
                  from tb_documentos a where id_documento > 0 and year(a.data_autor) > 0 and a.auto_por is not null " . $p3 . $p4 . $p5 . " order by a.tipo_doc ,a.id_documento desc, a.descr_docto ");				  
...
<table width="95%" border="0">
      <tr>
        ...
        <th  align="center"><h1>Consulta Laudos- 
        <?php
          ...
          <?php }}?>
            ...
            <tr bgcolor="#9D9DFF">
              <td height="15" colspan="4" align="center">Documentos Cadastrados</td>
                    ...
                    <td colspan="2"></tr>
      <tr>
        <th colspan="4" align="left">        Descri&ccedil;&atilde;o 
