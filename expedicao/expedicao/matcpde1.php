...
if($cod_prod == ""){$p1 = "";}
 ...
 $rs2 = mysql_query("select a.*,b.descr_prod
					...
					"where a.id_contraprov > 0 " . $p1 . $p01 . $p1a . $p1b ."  and a.situacao = 'D' order by a.data_descart desc");				  
...
<![endif]-->
	<title>MATCPDE1 - CONSULTA de DESCARTADOS - CONTRAPROVA PRODUTO ACABADO</title>
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="center" ><h1>Consulta Descartados - Contraprova - Produtos Acabados- 
        <?php
