	  ...
	  if($row['tt_lote'] > 0 ){
       ...
       if ($row['cod_prod'] != $cd_prodini && $tot_prod > 0){  ?>
              <tr bgcolor="#E1E1FF">
                ...
                <td align="right" ><?php  echo (number_format($tot_entrada,3,',','.'));?></td>
                <td align="right" ><?php  echo (number_format($tot_saida,3,',','.'));?></td>
                <td align="right"><?php  echo (number_format($tot_prod,3,',','.'));?></td>
              </tr>
           <?php 
			   $tot_prod = 0.00;
			   $tot_saida = 0.00;
...
//		      if ($row['msg_lote'] <> ""){ echo("<br> <font color=#999999> " . $row['msg_lote'] . "</font>");
	///		  }
		  ...
		  */
		   ...
		   ?></td>
           <td align="right"><?php echo (number_format(($row['tt_lote'] -$row['quantid_ent'] + $row['quantid_said']),3,',','.')); ?></td>
           <td align="right"><?php echo ( $row['quantid_ent']); ?></td>
           <td align="right"><?php echo ( $row['quantid_said']); 
...
//echo($b);
	  ...
	  while($rowxx=mysql_fetch_array($rs20a)){ 
        ...
        <?php
           ...
           <td align="center" ><?php echo (number_format($rowxx['saldo_anterior'],3,",",""));?></td>
           <td align="center" ><?php echo (number_format($rowxx['quantid_said'],3,",",""));?></td>
           <td align="center" ><?php echo ($rowxx['unidade']);?></td>
           <td align="center"><?php echo (number_format(($rowxx['saldo_anterior'] - $rowxx['quantid_said']),3,",","")); ?></td>
           <td align="left"><?php echo ($rowxx['lote_fabricado'] . " - " . $rowxx2['prod_fabric']);?></td>
           </tr>
          <?php 
	  } 
