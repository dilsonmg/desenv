...
$rs2 = mysql_query("SELECT a.cod_prod,b.descr_prod, year(a.data_saida) ano, month(a.data_saida) mes ,
					sum(a.quantid_said) tt_mes,c.saldo_prod FROM tb_saidmatp a
					inner join tb_produto b on a.cod_prod = b.cod_prod
...
<table width="100%" border="0">
      <tr>
        ...
        <th  align="center"><h3>Consumo Mensal de Materias Primas - Ano de Referencia : <?php echo($anodf); ?> </h3></th>
        <th align="right"><img src="../imagens/tecladoclaro.png" ><a href="menu_exped.php"><img src="../images/back_f2.png" width="32" height="32" border="0" alt="Voltar ao menu" /></a></th>
      </tr>
      </table>
