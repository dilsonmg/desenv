...
$rs2 = mysql_query("select a.* ,b.descr_centcustind
					 from tb_customind a
...
<table width="98%" border="0">
 ...
 <table width="98%" border="0">
      ...
      <tr>
        ...
        <th align="left"><select name="id_centcustoind" class="search-input5" <?php if($habilita ==1) echo(" disabled ");?>>
            ...
            <option value="<?php print($row33['id_centcustoind'])?>"
				 ...
				 ><?php print($row33['descr_centcustind'] )?></option>
            <?php }?>
        </select></th>
      </tr>
      <tr>
        ...
        <th align="left"><select name="mes_custoind" class="search-input3" >
          ...
          Ano
        <input type="text" id = "ano_custoind" required name="ano_custoind"  maxlength="4" size="10" placeholder="informe N.lote"  value="<?php echo($ano_custoind); ?>" class="search-input3"></th>
      </tr>
      <tr>
        <th align="right">Valor</th>
        <th align="left"><input type="text" id = "val_custoind" required name="val_custoind"  maxlength="15" size="30" placeholder="informe o valor"  value="<?php echo($val_custoind); ?>" class="search-input3" ></th>

       <tr>
         <th align="right">Observa&ccedil;&otilde;es</th>
         <th colspan="2" align="left"><input type="text" id = "obs_custoind" required name="obs_custoind"  maxlength="150" size="100" placeholder="Observacão"  value="<?php echo($obs_custoind); ?>" class="search-input" ></th>
       </tr>
      ...
      <tr>
        <th colspan="2" align="center">
          ...
          <input type="button" onClick="sair();" value="Sair"  class="search-submit2">
            ...
            <tr >
              <th colspan="2" align="center"><select name="id_centcustoind2" class="search-input5" <?php if($habilita ==1) echo(" disabled ");?>>
                <option value="">Selecione o Custo</option>
...
<input type="button" name="pesquisar"   value="Pesquisar"  class="search-submit2" onclick="resetForm();" /></th>
            </tr>
            <tr align="center">
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
       if($bg == 1){
           ...
           <td  alingn="left"> <?php  echo ($row['descr_centcustind']);?></td>
           <td  align="right"><?php echo (number_format($row['val_custoind'],3,",","."));
