...
<table width="100%" border="1">
      <tr>
        ...
        <th align="right"><h2><?php echo($hoje); ?> - 
        Controle de Vencimentos - <?php echo($linha2 . "  " .$data_1); if ($data_1 !="") { echo(" a ");} echo($data_2); ?> 
        ...
        <th colspan="3" align="left">Produto
          ...
          LInha
          <input type="text" id = "linha2" name="linha2"  maxlength="40" size="20" class="search-input4">
Periodo 
			 ...
			 $mqtd = "N";
			  ...
			  ?>
                 <tr bgcolor="#DFDFFF">
                    ...
                    <th align="center"><?php echo($row['quant_itg'] . " - " . $row['unid_amostrag'] ); ?></th>
                   <th>
