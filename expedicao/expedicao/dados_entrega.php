...
<table width="98%" border="1" cellspacing="0"  align="center" >
  <tr>
    ...
    <td colspan="6" align="center" ><table width="80%" border="1">
      <tr>
        <td colspan="2" align="center" bgcolor="#CCCCCC">Tabela de especifica&ccedil;&otilde;es QTA</td>
      </tr>
      <tr>
  ...
  <tr>
    <td colspan="9" align="center"  bgcolor="#F2F2CC" ><h3>Recebimento de Insumos -  Registro:<?php print($nvid);?>
      <input type="hidden" name="id_avlfornec" value="<?php print($nvid);?>" />    </h3></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Fonecedor : 
    ...
    <td  >Data</td>
    <td  ><input type="text" name="data_receb" size="10" maxlength="10" value="<?php echo formata_data($data_receb) ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_receb);"/></td>
    <td  bgcolor="#CCCCCC"><span >Insumo :</span></td>
    <td  colspan="3" bgcolor="#CCCCCC"><span ><font size="2" face="Arial, Helvetica, sans-serif">
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Nota Fiscal
      <input type="text" name="nfiscal" size="30" maxlength="20"  value="<?php echo($nfiscal) ?>"/></td>
    <td  >Pedido</td>
    <td  ><input type="text" name="pedido" size="20" maxlength="15" value="<?php echo($pedido) ?>" /></td>
    <td  bgcolor="#CCCCCC" colspan="2">Num. Lote </td>
    <td  colspan="3" bgcolor="#CCCCCC"><input type="text" name="num_lote" size="20" maxlength="15" value="<?php echo($num_lote) ?>"  onblur="valida_numlote();"/></td>
  </tr>
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Cor</td>
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Apar&egrave;ncia</td>
    <td colspan="2" bgcolor="#FFFFFF" ><input type="radio" name="espec_aparencia" 
    	<?php 
 ...
 />
    ...
    <td bgcolor="#CCCCCC" >
      Obs:      </td>
    <td colspan="3" bgcolor="#CCCCCC" ><input type="text" name="obs_aparencia" size="80" maxlength="80" value="<?php echo($obs_aparencia) ?>" /></td>
    </tr>
    <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Ph - Maximo  = 9 (Tixosil)</td>
    <td colspan="2" bgcolor="#FFFFFF" ><input type="radio" name="espec_ph" 
    	<?php 
	   if ($espec_ph == "S" ) {
		   print("Checked='checked'  ");
	   }
 ...
 />
    ...
    <td bgcolor="#CCCCCC" >
      Obs:      </td>
    <td colspan="3" bgcolor="#CCCCCC" ><input type="text" name="obs_ph" size="80" maxlength="80" value="<?php echo($obs_ph) ?>" /></td>
    </tr>
  
  <tr>
    <td colspan="9" align="center" bgcolor="#F2F2CC" ><b> Documenta&ccedil;&atilde;o</b></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Identifica&ccedil;&atilde;o do Funcion&aacute;rio</td>
    <td colspan="2" bgcolor="#FFFFFF" >
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Documentos fiscais(Quantidade,data de emiss&atilde;o, destinat&aacute;rio, n&uacute;mero de vias)?</td>
    <td colspan="2" bgcolor="#FFFFFF" ><input type="radio" name="docs_fiscais" 
    	<?php 
	   if ($docs_fiscais == "S" ) {
		   print("Checked='checked'  ");
	   }
 ...
 />
    ...
    <td bgcolor="#CCCCCC" >
      Obs:      </td>
    <td colspan="3" bgcolor="#CCCCCC" ><input type="text" name="obs_fiscai" size="80" maxlength="80" value="<?php echo($obs_fiscai) ?>" /></td>
    </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Certificado de An&aacute;lise </td>
    <td colspan="2" >
 ...
 value="S" />
      ...
      />
      N&atilde;o </td>
    <td colspan="3" bgcolor="#CCCCCC" >Produto Conforme ?</td>
  ...
  <tr>
    <td colspan="9" align="center" bgcolor="#F2F2CC" ><b>Transporte / Entrega</b></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Integridade f&iacute;sica do ve&iacute;culo ?</td>
    <td colspan="2" ><span >
      ...
      value="N" />
      N&atilde;o </span></td>
    <td colspan="2" bgcolor="#CCCCCC" ><span style="font-family: Arial, Helvetica, sans-serif; font-weight:">Obs</span></td>
    <td colspan="2"><span >
      <input type="text" name="obs_veic" size="80" maxlength="80" value="<?php echo($obs_veic) ?>"  />
    </span></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Ve&iacute;culo est&aacute; limpo ?</td>
    <td colspan="2" ><span >
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Aus&ecirc;ncia de Vetores e pragas ?</td>
    <td colspan="2" ><span >
  ...
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Apropriado ao tipo de carga ?</td>
    <td colspan="2" ><span >
      ...
      value="N" />
      N&atilde;o </span></td>
    <td colspan="2" bgcolor="#CCCCCC" ><span >Obs</span></td>
    <td colspan="2"><span >
      <input type="text" name="obs_aprop" size="80" maxlength="80" value="<?php echo($obs_aprop) ?>"/>
    </span></td>
  </tr>
  <tr>
    <td colspan="3" bgcolor="#CCCCCC" >Prazo de Entrega</td>
    <td colspan="6" bgcolor="#CCCCCC" ><font size="2" face="Arial, Helvetica, sans-serif">
  ...
  <tr>
    <td colspan="9" align="center" bgcolor="#F2F2CC"><b>Insumos</b></td>
  </tr>
  <tr>
    <td colspan="7" bgcolor="#CCCCCC"   size=3 >Integridade do produto(produto e embalagens danificadas, limpeza das embalagens, identifica&ccedil;&atilde;o do r&oacute;tulo) ?<br />      <span >O r&oacute;tulo deve conter nome, composi&ccedil;&atilde;o,data de fabrica&ccedil;&atilde;o, validade e lote</span></td>
    <td colspan="2" bgcolor="#CCCCCC"   size=3 ><font size="2" face="Arial, Helvetica, sans-serif">
  ...
  <tr>
    <td width="9%" height="23" bgcolor="#CCCCCC"><span >Quantidade</span></td>
    ...
    <td colspan="6" bgcolor="#CCCCCC"><span >Quando aplic&aacute;vel an&aacute;lises organol&eacute;pticas(aspecto,cor,odor e textura)</span></td>
  ...
  <tr>
    <td height="23" bgcolor="#CCCCCC" >Observa&ccedil;&otilde;es</td>
    <td colspan="8" bgcolor="#CCCCCC"><span >
  ...
  <?php
     if ($a == "") { ?>
  <tr>
    <th  colspan="9" align="center" bgcolor="#3B5998">
      ...
      <input type="button" name="Submit4"  onclick="javascript:voltar();" value="Sair" />
    </th>
  </tr>
