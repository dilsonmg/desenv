...
//    
	if ($m_primapesq != "" or $lote_fabr2 != ""){
	 	 ...
	 	 $rs2 = mysql_query("SELECT a.*,b.descr_prod,c.nome_cli,DATE_FORMAT(a.data_nf, '%d/%m/%Y') dt_nf,d.rz_social
		                     ,DATE_FORMAT(e.data_fab, '%d/%m/%Y') data_fab
		                     ,DATE_FORMAT(e.data_venc, '%d/%m/%Y') data_venc
			  ...
			  inner join tb_entmatp e on e.cod_prod = a.cod_prod and e.num_lote = a.num_lote
...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="2" align="center"><h1>Rastreamento por Cliente- 
        <?php
	echo($lote_fabr2);
		  ?>
      </h1></th></tr>
      <tr>
        <th colspan="2" align="center">Informe o Codigo ou Nome
...
?>
      ...
      <tr>
        <th colspan="2" align="center"  bgcolor="#8080FF">Dados da Saida</th>
            ...
            <tr >
              <th colspan="3" align="center"><h2> Lotes Adquiridos por Cliente -</h2></th>
            </tr>
</table>
<br>
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
           ...
           <td align="right" ><?php echo($row['data_fab']); ?></td>
...
<br><br>
            ...
            Quantidade Media de Volumes: <?php echo($media_compr); ?> 
     <?php    
	}
		  ?>    
</form> 
