...
$rs2000a = mysql_query("SELECT a.*,b.id_grpamostra,b.descr_grpam,b.qtd_kits,c.descr_prod,d.quant_disp FROM tb_compgrp a
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="center"><img src="../imagens/tecladoclaro.png" ><?php echo($hoje); ?></th>
      </tr>
            <tr >
              <th colspan="3" align="center"><input type="button" onClick="sair();" value="Sair"></th>
            </tr>
            <tr >
              <th colspan="3" align="center"><h2>Consulta Saldo dos Kits de Amostras-   </h2>
              <?php
	echo($_SESSION['id_entmatp']);
		  ?></th>
            </tr>
            <tr align="center">
              <td colspan="3" align="center"><p><h2>Amostras</h2></p></td>
         </tr>
