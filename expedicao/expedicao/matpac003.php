...
$rs2 = mysql_query("SELECT a.*
                    ,DATE_FORMAT(a.data_nf, '%d/%m/%Y') dt_nf
      FROM tb_saidaprodac a
	  where a.id_saidaprodac > 0   " . $p2 . $p1a ."	
...
//		
      ...
      <tr>
        ...
        <th align="left"><input type="text" id = "quantid"  name="quantid"  maxlength="10" size="10" placeholder="informe a Quantidade"  value="<?php echo(number_format($quantid,2,',',''));  ?>" ></th>
