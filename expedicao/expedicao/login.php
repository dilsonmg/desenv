...
if (senha == ""){
	...
	return false;
	 ...
	 document.form1.action = "validausu.php"
...
<title>SGQ - Sistema de Expedição</title>
...
<div align="center">
  <table width="98%" border="0">
    <tr align="center">
      ...
      <td  align="center"><font color="#666666"  size="+2">Gest&atilde;o de Processo Fabrica&ccedil;&atilde;o</font></td>
    </tr>
    <tr align="center">
      ...
      <td height="144" colspan="10" align="center" valign="middle"><form name="form1">
          <table width="29%" border="0" cellpadding="0" cellspacing="0" background="imagens/fundoriscadiagonal.gif">
            ...
            <tr> 
              ...
              <td ><input type="text" name="nome_usu" size="15" maxlength="15"></td>
            </tr>
            <tr> 
