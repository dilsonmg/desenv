...
if($cod_prod == ""){$p1 = "";}
 ...
 $rs2 = mysql_query("select a.*,b.descr_prod
					...
					"where a.id_contraprovm > 0 " . $p1 . $p01 . $p1a . $p1b ."  and a.situacao = 'A' order by a.venci_retencao asc");				  
...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="2" align="center"><h1>Consulta por Vencimento Contraprova - Materia Prima- 
        <?php
		   ...
		   <?php 
              ...
              if ($row['venci_retencao'] == ""){
				   echo ("Indeterminado !"); }
		   		   ...
		   		   echo (strftime("%d/%m/%Y", strtotime($row['venci_retencao'])));
