...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="4" align="center"><h1>Entrada de  Processados- 
        <?php
	echo($_SESSION['id_itproc']);
      ...
      <tr>
        ...
        <th align="left"><select name="cod_prod" style="font-size:10" <?php if($habilita ==1) echo(" READONLY ");?> onChange="atualiza();">
...
//		
		    ...
		    ?>
          <input type="text" name="num_lote" value="<?php echo($num_lote);?>" >
       </th>
      </tr>
      <tr>
        ...
        <th align="left"><input type="text" name="data_ent" size="8" maxlength="10" value="<?php if ($data_ent <> "" ){echo ($data_ent); }?>" 
          title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_ent);"
           onChange="verifica_data(this.value,data_ent);" placeholder="informe a Data"/></th>
      </tr>
      <tr>
        <th align="right">Observacao</th>
        <th colspan="3" align="left"><input type="text" size="100" maxlength="200" name="obs_ent" value ="<?php echo($obs_ent); ?>"></th>
      </tr>
      <tr>
        <th align="right">&nbsp;</th>
      ...
      <tr>
        <th colspan="5" align="center">
          <input type="button" name="gravar"  onClick="validaentitproc();" value="Gravar" style="font:color="#006600"-size:8" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="ResetFormValues('matam0008.php');" >
          <input type="button" name="Submit4"  onclick="excluirentitproc(<?php echo($id); ?>);" value="Excluir" style="font:color="#006600"-size:8" />
