...
<table width="95%" border="0">
      ...
      <tr>
      <th height="45" colspan="2" align="center"><h1>Composi&ccedil;&atilde;o Kits- 
        <?php
	echo($_SESSION['id_itproc']);
      ...
      <tr>
        ...
        <th align="left"><select name="id_grpamostra" style="font-size:10" <?php if($habilita ==1) echo(" disabled ");?> onChange="atualiza();">
      ...
      <tr>
        ...
        <th align="left"><input type="text" id = "quant_it"  name="quant_it"  maxlength="15" size="15" placeholder="informe a quantidade"  value="<?php echo($quant_it); ?>" ></th>
      </tr>
      <tr>
        <th align="right">Unidade</th>
        <th align="left"><input type="text" id = "unid_amostra"  name="unid_amostra"  maxlength="15" size="15" placeholder="informe a unidade"  value="<?php echo($unid_amostra); ?>" ></th>
      </tr>
      <tr>
        <th colspan="3" align="center">
          <input type="button" name="gravar"  onClick="validacompgrp();" value="Gravar" style="font:color="#006600"-size:8" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="ResetFormValues('matam0003.php?id=');" >
          <input type="button" name="Submit4"  onclick="excluircompgrp(<?php echo($id); ?>);" value="Excluir" style="font:color="#006600"-size:8" />
