...
session_start();
$mes_custoind2 = $_GET ["mc"];
$ano_custoind2 = $_GET ["ac"];
...
<table width="98%" border="0">
 ...
 <table width="98%" border="0">
      ...
      <tr>
        <th colspan="2" align="center"><input type="button"  onClick="self.close();" value="Sair"  class="search-submit2">
        </th>
        </tr>
       ...
       if($bg == 1){
		 ...
		 ?>  
          ...
          <tr  bgcolor="#D2D2FF">
             ...
             <th  align="right">&nbsp;</th>
             <th  align="right"><?php echo (number_format($tt_custo,2,",","."));?></th>
             <th  align="left">&nbsp;</th>
             <th  align="left">&nbsp;</th>
           </tr>    
         </table>
