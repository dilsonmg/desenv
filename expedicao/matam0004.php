...
<table width="95%" border="0">
      <tr>
        <th  align="left"><img src="../imagens/logoqrred.jpg" border="0"></th>
         <th align="center"><h1>Saidas De Kits de Amostras-     </h1></th>
        <th align="right"><img src="../imagens/tecladoclaro.png" ><br>          <?php echo($hoje); ?> <a  href=javascript:window.print()><img border="0" src="../imagens/print.png"    title="Imprimir"></a>
        </th>
      </tr>
</table>
<table width="95%" border="0">
      ...
      <tr>
        ...
        <th colspan="3" align="left"><select name="id_grpamostra"  <?php if($habilita ==1) echo(" disabled ");?> onChange="atualiza();" class="search-input5">
      ...
      <tr>
        ...
        value="<?php echo($num_nf); ?>" class="search-input4" ></th>
        ...
        <th align="left">
          ...
          title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_nf);"
           onChange="verifica_data(this.value,data_nf);" placeholder="informe a Data"   class="search-input5" />
        </th>
      </tr>
      <tr>
        <th align="right">Cliente</th>
        <th align="left"><input type="text" size="80" maxlength="100" name="obs_saida" value ="<?php echo($obs_saida); ?>" class="search-input5"></th>
        <th align="right">Qtd Kits</th>
        <th align="left"><input type="text" id = "quant_kits"  name="quant_kits"  maxlength="15" size="15" placeholder="informe a Quantidade"  
        value="<?php echo($quant_kits); ?>" class="search-input5" ></th>
      </tr>
      <tr>
	 ...
	 if ($b > 0){
      ...
      <tr>
        <th colspan="5" align="center">
          <input type="button" name="gravar"  onClick="validasaidaam();" value="Gravar"  class="search-submit2" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="ResetFormValues('matam0004.php?id=');" class="search-submit2" >
          <input type="button" name="Submit4"  onclick="excluirsaidaam(<?php echo($id); ?>);" value="Excluir"  class="search-submit2"/>
