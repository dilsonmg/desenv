...
select year(a.data_saida) ano_saida,
					 ...
					 where  a.cod_prod not in (190045,190105) and year(a.data_saida) > 2018
									 and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
									 group by year(a.data_saida), month(a.data_saida)
					union all
					select year(a.data_saida) ano_saida,
					 ...
					 where a.cod_prod in (190045,190105) and year(a.data_saida) > 2018
									 and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
									 group by year(a.data_saida), month(a.data_saida);



SELECT year(a.data_saida) ano_saida, month(a.data_saida) mes_saida,sum(a.quantid_said * d.valor_custo)*1000 total_custo
 FROM tb_saidmatp a
left outer join tb_custoprod d on d.cod_prod = a.cod_prod
where year(a.data_saida) > 2018
    and a.cod_prod  in (190045,190105)
    and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
    and d.ano_custo = year(a.data_saida)
    and d.mes_custo = month(a.data_saida)
 group by year(a.data_saida), month(a.data_saida);
 
 SELECT year(a.data_saida) ano_saida, month(a.data_saida) mes_saida,sum(a.quantid_said * d.valor_custo) total_custo
 FROM tb_saidmatp a
left outer join tb_custoprod d on d.cod_prod = a.cod_prod
where year(a.data_saida) > 2018
...
////////////////  geracao das tabelas auxiliares ////////////////////////////////////
	...
	$rs2 = mysql_query("select a.ano_saida,a.mes_saida,sum(a.total_custo) total_cmprim,
		  ...
		  echo("<table width='98%'><tr  bgcolor='#D2D2FF' >");	  
		  ...
		  echo("<td align='center'>Total Direto</td>" );
		  ...
		  */
		  ...
		  while($row=mysql_fetch_array($rs2)){
			  ...
			  if ($mes_soma != $row['mes_saida'] || $row['eof']){
				 //////////////////////////////////////////////////////////
	                echo("<tr bgcolor='#FFE3D7'><td colspan=4 align=center>T o t a i s  d o  M ê s : ---->>>></td>");
                    ...
                    echo("<td align='right'>" . number_format(($totg_mpr + $totg_ins ) ,2,",",".") . "</td>");					
					echo("<td align='right'>" . number_format($totg_ctind,2,",",".") . "</td>");
					echo("<td align='right'>" . number_format($totg_cttot,2,",",".") . "</td>");
				
					echo("<td align='right'>" .  number_format(($totg_ctind /$totg_cttot )*100 ,2,",",".") . "%</td>");					
			...
			echo('<tr ' . $bgc .'>');
			  ...
			  echo("<td align='left'>" . $row['linha'] . "</td>");
			  ...
			  echo("<td align='right'>" . number_format(($row['tot_insumomes']+$row['total_cmprim']),2,",",".") . "</td>");		  
	...
	//	}
		  ...
		  echo("<tr bgcolor='#FFE3D7'><td colspan=4 align=center >T o t a i s  d o  M ê s : ---->>>></td>");
				  ...
				  //////////////////////////////////////////////////////////
					...
					echo("<td align='right'>" . number_format($totg_mpr,2,",",".") . "</td>");
					echo("<td align='right'>" . number_format($totg_ins,2,",",".") . "</td>");
					echo("<td align='right'>" . number_format(($totg_ins+$totg_mpr),2,",",".") . "</td>");
		 ...
		 echo("<tr  bgcolor='#DFFFDF' >");	  
		  ...
		  echo("<td align='center'>Total Indireto</td>" );	 
		  echo("<td align='center'>Custo Total</td>" );	  
		  echo("<td align='center'>%Custo Ind</td>" );	  
		  echo("<td align='center'>C.Direto Kg</td>" );	  
		  echo("<td align='center'>Tot.Cust.Kg R$</td>" );	  
		...
		echo("<td align='right'>" . number_format(($totgg_ins+$totgg_mpr),2,",",".") . "</td>");
