...
<table width="99%" border="0">
      <tr>
        ...
        <th  align="center"><h1>Percentual de Perdas  - 
                    ...
                    while($rowx=mysql_fetch_array($rs3a)){ 
					   ...
					   if($rowx['tot_prod'] != null && $rowx['tot_prod'] > 0){
						 $var = ($rowx['tot_perda'] / $rowx['tot_prod'])*100 ;  
	   				   ...
	   				   $var_grafx = $var_grafx . "['".$mes[$rowx['mes_said']]. "',"  . $var."]," ;
    ...
    <script type="text/javascript">
    	/////////////////////////////////////////////// parametros do grafico //////////////////////////////////////
		 ...
		 function drawVisualization() {
				  ...
				  ['Mes','% Perda'],<?php echo($var_grafx);?>]);
				  		 
				var options = {
   				  		title : 'Percentual Mensal das Perdas '  ,
		  ...
		  fontScale: 15,
		  bar: { groupWidth: '60%' },
          colors: ['#1b9f97', '#d95f02', '#7570b3', '#7570b3', '#7570b3'],
		 'is3D':true,
         'width':750,
         'height':300,
		 isStacked: true,
...
<tr align="center">
  <th  align="center" id="chart_div<?php echo($cont)?>">
  </th>
...
//////////////////////////////////////////////////////
   ...
   ?>
    <script type="text/javascript">
    	/////////////////////////////////////////////// parametros do grafico //////////////////////////////////////
		 ...
		 function drawVisualization() {
				  ...
				  var data = google.visualization.arrayToDataTable([
				  ['Mes', 'Percentual'],<?php echo($var_grafx);?>]);
    ...
    <?php
	//	      echo("<tr><td colspan=15 align=center><div id=chart_div".$cont." style=width: 900px; height: 300px;></div></td></tr>");    				
