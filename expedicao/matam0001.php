...
<table width="95%" border="0">
      <tr>
        ...
        <th  align="center"><h1>Gerar Kits de Amostras- </h1></th>
      ...
      <tr>
        ...
        <select name="id" <?php if($habilita ==1) echo(" disabled ");?> onChange="atualiza();" class="search-input5">
      ...
      <tr>
        ...
        maxlength="15" size="20" placeholder="informe a quantidade de Kits"  value="<?php echo($qtd_kits); ?>" class="search-input4" ></th>
      </tr>
      <tr>
        <th colspan="2" align="center"><input type="button" name="gravar"  onClick="validagrpam();" value="Gravar"  class="search-submit2" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onClick="ResetFormValues('matam0001.php');" class="search-submit2"  >
          <!--input type="button" name="Submit4"  onClick="excluirgrpam(<?php echo($id); ?>);" value="Excluir"  /-->
