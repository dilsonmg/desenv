...
if (isset($tipo_doc2) && $tipo_doc2 != ""){
		// $p4 = " and a.id_eqpto like '%" . $id_eqpto1 ."%'" ; 
		 $p4 = " and a.descr_projeto like '" . $tipo_doc2 ."'" ; 
		 }
...
$rs2 = mysql_query("select a.* ,
                  ...
                  from tb_projeto a where a.id_projeto > 0 " . $p4 . " order by a.id_projeto desc");				  
...
//		 $data_fechamento  = $row1['data_fechamento'];
...
<table width="99%" border="0">
      ...
      <th  align="center"><h1>P &amp; D - Cadastro de Projetos- 
        <?php
...
<table width="99%" border="0">
      ...
      <tr>
        ...
        <th colspan="3" align="left"><input type="text" id = "descr_projeto" name="descr_projeto"
         maxlength="150" size="130"  value="<?php echo($descr_projeto); ?>" class="search-input"   ></th>
      </tr>
      <tr>
        <th align="right">Solicitante</th>
        <th align="left"><input type="text" id = "solicitante" name="solicitante" maxlength="60" size="60"
         value="<?php echo($solicitante); ?>" class="search-input5" ></th>
        <th align="right">Data Abertura</th>
        <th align="left"><input type="text" name="data_abertura" size="8" maxlength="10" 
         placeholder="Informe no formato 99/99/9999" value="<?php echo $data_abertura ?>"
         title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)"
          onBlur="verifica_data(this.value,data_abertura);" onChange="verifica_data(this.value,data_abertura);" class="search-input5"/></th>
      </tr>
     
      <tr>
        <th align="right">Documento Abertura</th>
        <th align="left"><input type="file" id="arq_instr" name="arq_instr" accept="*" 
        onChange="pegaArquivo(this.files)" value="<?php echo $doc_abertura ?>" class="search-input5"/>
          <a href="javascript:ver_foto('<?php  echo($doc_abertura);?>')"> Ver -
          <?php  echo($doc_abertura);?>
        </a></th>
        <th align="right">Lote:</th>
        <th align="left"><input type="text" id = "lote" name="lote" maxlength="20" size="30" 
         value="<?php echo($lote); ?>" class="search-input5" ></th>
      </tr>
      <tr>
        <th align="right"> Prev. T&eacute;rmino</th>
        <th align="left"><input type="text" name="data_prevtermino" size="8" maxlength="10"  placeholder="Informe no formato 99/99/9999" value="<?php echo $data_prevtermino ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_prevtermino);" onChange="verifica_data(this.value,data_prevtermino);" class="search-input5"/></th>
        <th align="right">T&eacute;rmino</th>
        <th align="left"><input type="text" name="data_fechamento" size="8" maxlength="10"  placeholder="Informe no formato 99/99/9999" value="<?php echo $data_fechamento ?>" title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_fechamento);" onChange="verifica_data(this.value,data_fechamento);" class="search-input5"/></th>
      </tr>
      <tr>
        <th align="right">Documento Fechamento</th>
        <th colspan="2" align="left"><input type="file" id="arq_instr2" name="arq_instr2" accept="*" onChange="pegaArquivo(this.files)" class="search-input5" />
          <a href="javascript:ver_foto('<?php  echo($doc_fecha);?>')"> Ver -
          <?php  echo($doc_fecha);?>
        </a></th>
        <th align="left">
          <input  type="checkbox"  name="remove_docfech" id="remove_docfech" value="1" >
          Remover Doc. Fechamento
      ...
      <tr>
        ...
        <th colspan="2" align="left">
              <input readonly type=hidden name=x size=3 maxlength=3 value="170">

              <textarea name="obs_projeto" cols="120" rows="3" onKeyDown="textCounter(this.form.obs_projeto,this.form.x,170);" onBlur="textCounter(this.form.obs_projeto,this.form.x,170);" class="search-input" ><?php echo($obs_projeto) ?> </textarea>
              </th>   
           <th>
      ...
      <tr>
        <th colspan="5" align="center">
		  ...
		  <?php }else { ?>
          <input type="button" name="gravar"  onClick="validaform();" value="Gravar"  class="search-submit2"  />
          <input type="button" name="button" id="button" value="Novo" onclick="resetForm();"  class="search-submit2" >
          <input type="button" name="Submit4"  onclick="excluir_projeto(<?php echo($id); ?>);" value="Excluir"  class="search-submit2"  />
          ...
          <?php }?>
            ...
            <tr bgcolor="#9D9DFF">
              <td height="15" colspan="5" align="center">Projetos Cadastrados</td>
            </tr>
                    </tr>
      <tr>
        <th colspan="5" align="left">Projeto 
          <input type="text" id = "descpro" name="descpro" maxlength="60" size="60"  value="" class="search-input5" ></th>
      </tr>
            ...
            <tr align="center">
              ...
              <table width="100%" border="1">
                <tr bgcolor="#D2D2FF" >
                  ...
                  <th width="5%" >Abertura</th>
                  <th width="16%" >Doc. Abertura</th>
                  <th width="6%" >Prev.Termino</th>
                  <th width="5%" >Termino</th>
                  <th width="18%" >Lote</th>
                  <th width="18%" >Doc. Fechamento</th>
                  <th width="26%" >Situa&ccedil;&atilde;o</th>
                  <th width="26%" >Obs</th>
                </tr>
     <?php
//echo($b);
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
                  ...
                  <tr>
                    <td height="22" >
           <a href="proj0001.php?id=<?php echo ($row['id_projeto']);?>"><?php echo ($row['id_projeto']);?></a></td>
