...
$aResult = gravarreg($id,$cod_prod,$num_lote,$quantid,$data_ped,$a,$pedido,$cliente,$id_usuaped );
	  ...
	  if ($cp6 <> "E") {   
		  ...
		  echo ('a='.$a);
			if ($a == 0){
				   ...
				   $sqlins = "insert into tb_peddia(id_peddia,cod_prod,num_lote,quantid,data_ped,num_pedido,codigo_cli,id_usuped)
							values('$cp1','$cp2','$cp3','$cp4','$cp5','$cp7','$cp8','$cp9')";
							
				   echo("insert into tb_peddia(id_peddia,cod_prod,num_lote,quantid,data_ped,num_pedido,codigo_cli,id_usuped)
							values('$cp1','$cp2','$cp3','$cp4','$cp5','$cp7','$cp8','$cp9')");			
               ...
               echo("update tb_peddia set quantid = '"   . $cp4 . "'  where id_peddia = '".$cp1."'");
		        ...
		        $sqlins = "update tb_peddia set quantid = '"   . $cp4 .
				          "',num_pedido = '". $cp7 .
						  "',codigo_cli = '".$cp8 .				
				 "'  where id_peddia = '".$cp1."'";
