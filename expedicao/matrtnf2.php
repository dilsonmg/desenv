...
<table width="95%" border="0">
      <tr>
        <th align="left" ><img src="../imagens/logoqrred.jpg" border="0"></th>
           <th height="45" colspan="2" align="center"><h1>Rastreamento por Nota Fiscal- 
        <?php
	echo($lote_fabr2);
		  ?>
      </h1></th>
...
<table width="95%" border="0">
      <tr>
        <th colspan="2" align="center">Informe o 
          Num. da NF
          <input type="text" id = "lote_fabr2"  name="lote_fabr2"  maxlength="45" size="42" placeholder="informe codigo ou o nome"  value="" autofocus>
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
         ...
         <br><br>
            ...
            Quantidade Média de Volumes: <?php echo($media_compr); ?> 
     <?php    
	}
		  ?>    
</form> 
