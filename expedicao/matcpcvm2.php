...
if($cod_prod == ""){$p1 = "";}
 ...
 $rs2 = mysql_query("select a.*,b.descr_prod
					...
					"where a.id_contraprovm > 0 " . $p1 . $p01 . $p1a . $p1b ."  and a.situacao = 'A' order by a.data_fabr desc,a.num_lote asc");				  
...
<table width="95%" border="0">
      <tr>
        ...
        <th  align="center"><h1>Consulta por Dt. Fabrica&ccedil;&atilde;o Contraprova - Materia Prima- 
        <?php
