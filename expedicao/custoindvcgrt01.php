...
if(isset($id_despreal2)){
	if($id_despreal2 != ""){
		$p1 = " and a.id_despreal = '" .$id_despreal2 . "'";
	}
}
$p1a = '';
$p2a = '';
...
$rs2 = mysql_query("select a.cod_sidespreal,sum(val_custoreal) tot_item ,b.descr_despreal,b.cod_sidespreal as id_despreal,d.id_grupocusto,d.descr_grupocc
                    from tb_custoreal a
...
<table width="98%" border="0">
 ...
 <table width="98%" border="0">
 <tr>
    <th colspan="2" align="center"><select name="id_despreal2" class="search-input6" <?php if($habilita ==1) echo(" disabled ");?>>
                <option value="">Selecione o Custo</option>
                <?php while($row331=mysql_fetch_assoc($rs331)){ ?>
                <option value="<?php print($row331['id_despreal'])?>"
				  <? if($row331['id_despreal'] == $id_despreal2 ) {?>selected <? } ?>				
...
google.charts.setOnLoadCallback(drawChart);
 ...
 function drawChart() {
       ...
       var options = {
          title : 'Custos Mensais por linha - Período :  <?php echo($mes_custoreal . "/". $ano_custoreal . " a " .$mes_custorealf . "/". $ano_custorealf );?> ',
          vAxis: {title: 'Total'},
          hAxis: {title: 'Linha'},
          seriesType: 'bars',
          series: {6: {type: 'line'}}
...
<tr align="center">
  ...
  <th>
    <div id="chartDiv1" style="width: 850px; height: 300px;"></div>
  </th>
