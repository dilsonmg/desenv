...
$tempo_permitido = 5400;
$fim = "";
if($_COOKIE['Cookie_countdown']=="") {
$tempo_entrada = @mktime(date("%H%M%S"));
$tempo_cookie = '6700'; // em segundos
...
$rs2 = mysql_query("SELECT a.*,b.descr_prod,c.nome_cli 
	 ...
	 order by id_saidaprodac desc limit 25 ");		 		  
...
if (isset($_POST['msg_lote'])){
	...
	if (!is_null( $_POST['msg_lote']) &&  $_POST['msg_lote'] <> ''){
...
var contador = '<?php if($fim=="") { echo $tempo_gerado+1; } else { echo $fim; } ?>';
function Conta() {
if(contador <= 0) {
...
<table width="95%" border="0">
      <tr>
        ...
        <th colspan="5" align="center"><img src="../imagens/tecladoclaro.png" ></th>
      </tr>
      <tr>
      <th height="45" colspan="6" align="center"><h1>Sa&iacute;das de Produtos Acabados- 
        <?php
...
//		
      ...
      <tr>
        ...
        <th align="left"><font size="4"><?php echo(number_format($sald_lote,0,',','')); ?> </font></th>
      ...
      <tr>
        ...
        <input type="submit" name="gravaobs"  value="Gravar Obs" style="font:color="#006600"-size:8" /></th>
      </tr>
      <tr>
        <th align="right">Filtro Cliente</th>
        <th colspan="5" align="left">    <input type="text" name="cli_filtro" id="textfield" size="80" maxlength="80"  placeholder="informe Nome ou Codigo"  />
          <input type="submit" name="Submit"  value="Filtrar" style="font:color="#006600"-size:8" /></th>
      </tr>
      <tr>
        <th colspan="6" align="center"  bgcolor="#8080FF">Dados da Saida</th>
      </tr>
      <tr>
        <th align="right">Cliente</th>
        <th colspan="3" align="left">
        <select name="codigo_cli" style="font-size:10" <?php if($habilita ==1) ?> >
          ...
          <option value="<?php print($row320['codigo_cli'])?>"
				 ...
				 ><?php print($row320['codigo_cli'] . " - " . $row320['nome_cli'] )?></option>
          <?php }?>
        </select></th>
      ...
      <tr>
        ...
        <th align="left"><input type="text" id = "quantid"  name="quantid"  maxlength="10" size="10" placeholder="informe a Quantidade"  value="<?php echo(number_format($quantid,0,',',''));  ?>" ></th>
      ...
      <tr>
        <th colspan="7" align="center">
          <input type="button" name="gravar"  onClick="validasaidaprodc();" value="Gravar" style="font:color="#006600"-size:8" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="resetForm();" >
          <input type="button" name="Submit4"  onclick="excluirsaidaprodac(<?php echo($id); ?>);" value="Excluir" style="font:color="#006600"-size:8" />
          <input type="button" onClick="sair();" value="Sair">
        </th>
        </tr>
            <tr >
              <th colspan="7" align="center"><h1>Registros de Sa&iacute;das Produtos Acabados</h1></th>
            </tr>
            <tr >
              <th colspan="7" align="center">
                Produto
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
           ...
           <a href="matpac003.php?id=<?php echo ($row['id_saidaprodac']);?>"><?php echo ($row['cod_prod'] . " - " . $row['descr_prod']);
		    
		   ?></a> 
		   <?php  if($bxx == 0){echo("<b> <font color = red> <a href='matpacd03.php?id=". $row['id_saidaprodac'] ."'>* EXCLUIR *</a> </font> <b>");} ?>
