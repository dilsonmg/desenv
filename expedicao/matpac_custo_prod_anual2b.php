...
<table width="99%" border="0">
      <tr>
        ...
        <th align="center" ><h1>Custos Mensais dos Produtos</h1></th>
      ...
      <table width="99%" border="0">
            ...
            <tr >
              <th  align="center"><select name="mes_i" class="search-input5" >
              ...
              <th  align="center">Ano                
              <input type="text" name="ano_2" id="ano_2" maxlenght="4" size=8 onChange="atualiza()"  value = "<?php echo($ano_2);?>"  class="search-input5" /></th>
...
////////////////  geracao das tabelas auxiliares ////////////////////////////////////
		  ...
		  //echo("<h2>Linha : ".$linha_prod. "</h2>");
		   ...
		   if ($mes_i > 0){
			   $pr1 = " and a.mes_saida = '".$mes_i ."'";
			   $pr3 = " and month(a.data_saida)= '" .$mes_i . "'";

		   }
		   if ($ano_2 > 0){
			   $pr2 = " and a.ano_saida = '".$ano_2 ."'";
			   $pr4 = " and year(a.data_saida)= '" .$ano_2 . "'";
		   }
		   ...
		   $rs_drop1 = "drop table tmp_totprod";
		   mysql_query($rs_drop1);
		   
		   $rs_tbtemp1 = "create table tmp_totprod as
		                     SELECT year(b.data_pr) ano_prod, month(b.data_pr) mes_prod,sum(b.kg_realizado) tt_realizadomes FROM tb_producao1 b
								  where  lpad(b.lote_realizado,6,'0') in (SELECT a.lote_fabricado FROM tb_saidmatp a
								 where id_saidmat > 0  " . $pr3 . $pr4 . "	 and mid(a.cod_prod,1,2)  = 10 and a.motivo != 3
										   group by a.lote_fabricado)
								group by year(b.data_pr),month(b.data_pr)";

		   
		   mysql_query($rs_tbtemp1);
		   ...
		   $gera_saida = "S";
			...
			$rs_tbtemp = "CREATE TABLE tmp_totmprim AS		 
				select distinct year(a.data_saida) ano_saida, month(a.data_saida) mes_saida
											 ...
											 inner join tb_custoprod d on d.cod_prod = a.cod_prod and d.ano_custo = '" . $ano_2 ."'
							   and d.mes_custo = month(a.data_saida) and d.ano_custo = year(a.data_saida)
											 inner join tb_produto e on e.cod_prod = b.cod_prod     and e.flag_calccust != 'N'
											 where year(a.data_saida)= '"  . $ano_2 ."'" .  $p03 . "
											 and mid(a.cod_prod,1,2)  = 10 and a.motivo != 3
											 group by a.cod_prod,b.cod_prod,year(a.data_saida), month(a.data_saida)
											 order by year(a.data_saida), month(a.data_saida),b.cod_prod	";
	...
	/*
		   $rs_resumocusto = "CREATE TABLE tmp_resumocusto AS
								select a.cod_prod as cd_matprima,year(a.data_saida) ano_saida,
									 ...
									 inner join tb_custoprod d on d.cod_prod = a.cod_prod and d.ano_custo = year(a.data_saida)
									  and d.mes_custo = month(a.data_saida)
									 where year(a.data_saida)= '" . $ano_2 . "'". $p03 . " 
					 and a.cod_prod not in (190045,190105)
									 and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
									 group by a.cod_prod,year(a.data_saida), month(a.data_saida),b.cod_prod
		...
		*/
				   $rs_resumocusto = "CREATE TABLE tmp_resumocusto AS
								select a.cod_prod as cd_matprima,year(a.data_saida) ano_saida,
									 ...
									 where year(a.data_saida)= '" . $ano_2 . "'". $p03 . "  and a.cod_prod not in (190000,199481)
									 and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
									 group by a.cod_prod,year(a.data_saida), month(a.data_saida),b.cod_prod
					union all
					select a.cod_prod as cd_matprima,year(a.data_saida) ano_saida,
									 ...
									 left outer join tv_saldoltprac b on a.lote_fabricado = b.num_lote
									 left outer join tb_custoprod d on d.cod_prod = a.cod_prod and d.ano_custo = year(a.data_saida) and d.mes_custo = month(a.data_saida)
										 where year(a.data_saida)= '" . $ano_2 . "'". $p03 . " and a.cod_prod in (190000,190481)
									 and mid(a.cod_prod,1,2)  <> 10 and a.motivo != 3
									 group by a.cod_prod,year(a.data_saida), month(a.data_saida),b.cod_prod ";   
		   ...
		   $rs_resumocusto = "CREATE TABLE tmp_ttins_pa AS		 
							   select a.ano_saida,a.mes_saida,sum(a.total_custo) tot_insumomes,a.cod_prod
								   from tmp_resumocusto a where a.cod_prod > 0 " . $pr1 . $pr2 . "
								   group by a.ano_saida,a.mes_saida,a.cod_prod
								   order by a.ano_saida,a.mes_saida,a.cod_prod  ";
		   mysql_query($rs_resumocusto);
	...
	$rs2 = mysql_query("select a.ano_saida,a.mes_saida,sum(a.total_custo) total_cmprim,
							   a.cod_prod,a.descr_prod,a.linha,b.total_prod ,(sum(a.total_custo)/b.total_prod ) tot_mprimkg, c.tot_insumomes,
							   (c.tot_insumomes / b.total_prod) totcusto_kg, d.valor_dolar , 
							   ((c.tot_insumomes / b.total_prod) / d.valor_dolar ) insumos_kg_dolar,
							   ((sum(a.total_custo)/b.total_prod )/ d.valor_dolar ) tot_mprimkg_dolar,
						...
						from tmp_totmprim a
								...
								left outer join tmp_ttins_pa c on c.cod_prod = a.cod_prod
										   and c.ano_saida = a.ano_saida and c.mes_saida = a.mes_saida
								left outer join tb_dolarmes d on d.ano_dolar = a.ano_saida and d.mes_dolar = a.mes_saida
								inner join tv_custoindmesano e on e.ano_custoind = a.ano_saida and e.mes_custoind = a.mes_saida
								inner join tmp_totprod f on f.ano_prod  = a.ano_saida and f.mes_prod = a.mes_saida
						group by a.ano_saida,a.mes_saida,a.cod_prod
						order by a.ano_saida,a.mes_saida,a.cod_prod ");
	
		  echo("<table width='100%'><tr  bgcolor='#D2D2FF' >");	  
		  echo("<th align='center'>Mes</th>" );
		  echo("<th align='center'>Ano</th>" );	  
		  echo("<th align='center'>Produto</th>" );	  
		  echo("<th align='center'>Linha</th>" );	  
		  echo("<th align='center'>Total Produzido</th>" );	 
		  echo("<th align='center'>Total M.Prima</th>" );	 
		  echo("<th align='center'>Total Insumo</th>" );
		  echo("<th align='center'>Total Direto</th>" );
		  echo("<th align='center'>Custo Indireto</th>" );	 
		  echo("<th align='center'>Custo Total</th>" );	  
		  echo("<th align='center'>% Custo Ind</th>" );	  
		  echo("<th align='center'>C.Ind. Kg</th>" );	  
		  echo("<th align='center'>C.Direto Kg</th>" );	  
		  echo("<th align='center'>Tot.Cust.Kg R$</th>" );	  
		  echo("<th align='center'>Custo Kg U$</th>" );	  
		  echo("<th align='center'>U$ Mês</th>" );	   	  
		  echo("</tr>");	  
		...
		if ($gera_saida == "S"){ 
         ...
         $dolar_mes1=1;
		  ...
		  while($row=mysql_fetch_array($rs2)){
			  ...
			  if ($mes_soma != $row['mes_saida'] || $row['eof']){
				 //////////////////////////////////////////////////////////
	                echo("<tr bgcolor='#FFE3D7'><th colspan=4 align=center>T o t a i s  d o  M ê s : ---->>>></th>");
					echo("<th align='right'>" . number_format($totg_prod,3,",",".") . "</th>");
					echo("<th align='right'>" . number_format($totg_mpr,2,",",".") . "</th>");
					echo("<th align='right'>" . number_format($totg_ins,2,",",".") . "</th>");
                    echo("<th align='right'>" . number_format(($totg_mpr + $totg_ins ) ,2,",",".") . "</th>");					
					echo("<th align='right'>" . number_format($totg_ctind,2,",",".") . "</th>");
					echo("<th align='right'>" . number_format($totg_cttot,2,",",".") . "</th>");
				
					echo("<th align='right'>" .  number_format(($totg_ctind /$totg_cttot )*100 ,2,",",".") . "%</th>");					
					echo("<th align='right'>" .  number_format(($totg_ctind /$totg_prod ),2,",",".") . "</th>");					
				...
				/*	echo("<th align='right'");
				  ...
				  */
				    echo("<th align='right'>" . number_format(($totg_mpr + $totg_ins )/$totg_prod ,2,",",".") . "</th>");					
                    echo("<th align='right'>" . number_format(($totg_cttot)/$totg_prod ,2,",",".") . "</th>");					
                    echo("<th align='right'>" . number_format(($totg_cttot/$totg_prod)/$dolar_mes1 ,2,",",".") . "</th>");					
                    echo("<th align='right'>" . number_format($dolar_mes1 ,2,",",".") . "</th>");					
			...
			echo('<tr ' . $bgc .'>');
			  ...
			  echo("<th align='center'>" . $mes_a[$row['mes_saida']] . "</th>");
			  echo("<th align='center'>" . $row['ano_saida'] . "</th>");
			  echo("<th align='left'>" . $row['cod_prod'] . " - " . $row['descr_prod'] . "</th>");
			  echo("<th align='left'>" . $row['linha'] . "</th>");
			  echo("<th align='right'>" . number_format($row['total_prod'],3,",",".") . "</th>");

//  		  	  $var_graf = $var_graf . "['".$row['cod_prod'] . " - " . trim($row['descr_prod']) . "'," . number_format($row['total_prod'],0,"","").  "],";

			  $totg_prod = $totg_prod + $row['total_prod'];
			  $totgg_prod = $totgg_prod + $row['total_prod'];
			  
			  echo("<th align='right'>" . number_format($row['total_cmprim'],2,",",".") . "</th>");
	
			  $totg_mpr = $totg_mpr + $row['total_cmprim'];
			  $totgg_mpr = $totgg_mpr + $row['total_cmprim'];
			  
			  echo("<th align='right'>" . number_format($row['tot_insumomes'],2,",",".") . "</th>");		  
			  echo("<th align='right'>" . number_format(($row['tot_insumomes']+$row['total_cmprim']),2,",",".") . "</th>");		  
			  ...
			  echo("<th align='right'>" . number_format($row['custo_ind_prod'],2,",",".") . "</th>");
			  
			  $totg_ctind = $totg_ctind + $row['custo_ind_prod'];
			  $ttger_ctind = $ttger_ctind + $row['custo_ind_prod'];
			  
			  echo("<th align='right'>" . number_format($row['total_custo'],2,",",".") . "</th>");
	...
	//  echo("<th align='right'>" . number_format((($row['custo_ind_prod'] / ($row['total_cmprim'] + $row['tot_insumomes'] )*100)) ,2,",",".") . "%</th>");
		 
		  echo("<th align='right'>");
		  if ($row['total_custo'] > 0) {
		   echo(number_format(((($row['custo_ind_prod'] / $row['total_custo'])*100)) ,2,",","."));
		  }
		  echo("%</th>");
			  
	
			  echo("<th align='right'>" . number_format(($row['custo_ind_prod']/$row['total_prod']),2,",",".") . "</th>");
			  
			  $totg_kgre = $totg_kgre + $row['total_custo'];
			  echo("<th align='right'>" . number_format($custo_ind_prod ,2,",",".") . "</th>");
			  ...
			  echo("<th align='right'>" . number_format($row['valor_dolar'],2,",",".") . "</th>");
	...
	//	}
	       ...
	       echo("<tr bgcolor='#FFE3D7'><th colspan=4 align=center>T o t a i s  d o  M ê s : ---->>>></th>");
			...
			echo("<tr  bgcolor='#D2D2FF'> <th colspan= 15 align=center>Resumo Geral</th></tr>");
		 echo("<tr  bgcolor='#DFFFDF' >");	  
		  echo("<th align='center' colspan='3'>Somatório ---->>></th>" );
		  echo("<th align='center'>Total Produzido</th>" );	 
		  echo("<th align='center'>Total M.Prima</th>" );	 
		  echo("<th align='center'>Total Insumo</th>" );
		  echo("<th align='center'>Total Direto</th>" );	  
	  
		  echo("<th align='center'>Total Indireto</th>" );	 
		  echo("<th align='center'>Custo Total</th>" );	  
		  echo("<th align='center'>%Custo Ind</th>" );	  
		  echo("<th align='center'>C.Direto Kg</th>" );	  
		  echo("<th align='center'>Tot.Cust.Kg R$</th>" );	  
		...
		echo("<th align='left' colspan='3'> &nbsp; </th>" );
		echo("<th align='right'>" . number_format($totgg_prod,3,",",".") . "</th>");
		echo("<th align='right'>" . number_format($totgg_mpr,2,",",".") . "</th>");
		echo("<th align='right'>" . number_format($totgg_ins,2,",",".") . "</th>");
		echo("<th align='right'>" . number_format(($totgg_ins+$totgg_mpr),2,",",".") . "</th>");
		echo("<th align='right'>" . number_format($ttger_ctind,2,",",".") . "</th>");
		
		echo("<th align='right'>" . number_format($totgg_cttot,2,",",".") . "</th>");
	
		
		echo("<th align='right'>" . number_format((($ttger_ctind / $totgg_cttot)*100) ,2,",",".") . "%</th>");
		echo("<th align='right' >" . number_format((($totgg_ins+$totgg_mpr)/$totgg_prod),2,",",".") . "</th>");
	   ...
	   // echo("<th align='right'>" . number_format($custo_ind_prod,2,",",".") . "</th>");
		echo("<th align=right>" . number_format(($totgg_cttot/$totgg_prod)/$dolar_mes1 ,2,",",".") . "</th>");
		echo("<th align=right>" . number_format($dolar_mes1 ,2,",",".") . "</th>");

	  /*
		echo("<th align='right'>" . number_format($totg_kgre,2,",",".") . "</th>");
		echo("<th align='right'>" . number_format($totg_kgus,2,",",".") . "</th>");
		*/
		echo("</tr></table>");
