...
//DATEDIFF(t.data_conserto,CURDATE())
 ...
 $rs2 =mysql_query("SELECT a.id_entitproc,a.cod_prod,a.num_lote,a.quant_it,b.descr_prod,  DATE_FORMAT(a.data_ent, '%d/%m/%Y') data_ent1,
     ...
     FROM tb_entitproc a
	  left outer join tb_entprodac c on a.cod_prod = c.cod_prod and c.num_lote = a.num_lote
...
<table width="95%" border="0">
      <tr>
        ...
        <th  align="center"><h1>Entrada de  Processados-   </h1></th>
...
<table width="95%" border="0">
      <tr>
        ...
        <th align="left"><select name="cod_prod"  <?php if($habilita ==1) echo(" READONLY ");?> onChange="atualiza();" class="search-input5">
        ...
        <th align="left"><input type=hidden name="lm" value="<?php echo($lm); ?>">
          <?php 
//  
//		
    
		    ?>
          <input type="text" name="num_lote" value="<?php echo($num_lote);?>" class="search-input6" >
       </th>
      </tr>
      <tr>
        <th align="right">Quantidade KG</th>
        <th align="left"><input type="text" id = "quant_it"  name="quant_it"  maxlength="15" size="15" placeholder="informe a quantidade" 
         value="<?php echo($quant_it); ?>" class="search-input6"></th>
        <th align="left">Data Entrada</th>
        <th align="left"><input type="text" name="data_ent" size="8" maxlength="10" value="<?php if ($data_ent <> "" ){echo ($data_ent); }?>" 
          title="Informe no Formato 99/99/9999" onKeyPress="mascara(this)" onBlur="verifica_data(this.value,data_ent);"
           onChange="verifica_data(this.value,data_ent);" placeholder="informe a Data" class="search-input6"/></th>
      </tr>
      <tr>
        <th align="right">Observa&ccedil;&atilde;o</th>
        <th colspan="3" align="left"><input type="text" size="100" maxlength="200" name="obs_ent" value ="<?php echo($obs_ent); ?>" class="search-input2"></th>
      </tr>
      <tr>
        <th align="right">&nbsp;</th>
      ...
      <tr>
        <th colspan="5" align="center">
          <input type="button" name="gravar"  onClick="validaentitproc();" value="Gravar" class="search-submit2" />
          <input type="button" name="button" id="button" value="Limpar Formulario" onclick="ResetFormValues('matam0008.php');" class="search-submit2">
          <input type="button" name="Submit4"  onclick="excluirentitproc(<?php echo($id); ?>);" value="Excluir" class="search-submit2" />
          <input type="button" onClick="sair();" value="Sair" class="search-submit2">
        </th>
        </tr>
            <tr >
              <td colspan="5" align="center" bgcolor="#A6A6FF">Entradas de Processados</td>
            </tr>
            <tr >
              <th colspan="5" align="center">
                Produto
	 ...
	 if ($b > 0){
	  ...
	  while($row=mysql_fetch_array($rs2)){ 
	   ...
	   echo('<tr ' . $bgc .'>');?>
           ...
           <td align="center"><?php echo ($row['quant_it']);?> g</td>
