...
$sald_lote = str_replace(",",".",$sald_lote);

ini_set("max_execution_time", 3600);
ini_set("memory_limit","128M");

$aResult = gravarreg($id,$cod_prod,$num_lote,$data_saida,$quantid_said,$lote_fabricado,$sald_lote,$unidade,$a,$obs,$motivo);
