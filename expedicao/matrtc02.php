...
//    
	if ($m_primapesq != "" or $lote_fabr2 != ""){
	 	 ...
	 	 $rs2 = mysql_query("SELECT a.*,b.descr_prod,c.nome_cli,DATE_FORMAT(a.data_nf, '%d/%m/%Y') dt_nf
	          ...
	          group by a.cod_prod,a.codigo_cli limit 300 ");		
...
function resetForm(){
   // if (confirm("Confirma limpeza do formulário  ?")){
		  ...
		  document.form1.num_lote.value = '';
   	   	  document.form1.action="matrtc02.php";
		  document.form1.submit();  
		  return true;
	//	  }
...
<table width="95%" border="0">
	...
	echo($lote_fabr2);
      ...
      <tr>
        ...
        <?php if ($sr == ""){ ?>
             <input type="button" onClick="sair11();" value="Sair">
        <?php }else { ?>
